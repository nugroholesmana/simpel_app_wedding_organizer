...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('pesanan/add', $attributes) ?>
          	<div class="box-body">
			<?php echo validation_errors('<p class="text-danger">','</p>'); ?>
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_pelanggan" class="form-control select" id="id_pelanggan">
								...
								{
									$selected = ($value['id_pelanggan'] == $this->input->post('id_pelanggan')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tgl_resepsi" min="<?php echo date("Y-m-d")?>" value="<?php echo $this->input->post('tgl_resepsi'); ?>" class="has-datepicker form-control" id="tgl_resepsi" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<option value="">Pilih Vendor</option>
								...
								{
									$selected = ($value['id_vendor'] == null) ? ' selected="selected"' : "";
					...
					<div id="paket_pesanan" style="display:none">
					<div class="col-md-6">
						<div class="col-md-12">
							<h3>Daftar Paket</h3>
							<hr>
						...
						<div class="col-md-12" id="jumlah_tamu_display" style="display:none">
							<label for="id_catering" class="control-label">Jumlah Tamu</label>
							<div class="form-group">
								<input type="text" name="jumlah_tamu" value="<?php echo $this->input->post('jumlah_tamu'); ?>" class="form-control" id="jumlah_tamu" />
