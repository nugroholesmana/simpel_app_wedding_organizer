    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
            	...
            	<div class="box-tools">
                    <a href="<?php echo site_url('paket/add'); ?>" class="btn btn-success btn-sm">Add</a> 
                </div>
            </div>
            <div class="box-body">
                <br/><br/>
                <?php echo form_open('paket/index') ?>
                <div class="col-md-2">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo site_url('paket') ?>" class="btn btn-info">Tampilkan Semua</a>
                </div>
                <?php echo form_close() ?>
                <br/><br/>
            <?php echo $this->session->flashdata('notif_input') ?>
                <table class="table table-striped">
                    ...
                    <tr>
						...
						<td>
                            <a href="<?php echo site_url('paket/edit/?q='.urlencode($this->encrypt_aspireone->encode($t['id_konten']))); ?>" class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a> 
                        ...
                        $("#remove<?php echo $t['id_konten'] ?>").click(function() {
                            ...
                            $.ajax({
                                ...
                                success:function(msg){
                                    if(msg == "true"){
                                        window.location.href = '<?php echo site_url("paket") ?>';
                                    }    
                                },
                                error:function(){
                                    window.location.href = "<?php echo site_url('paket') ?>";
